...
github: https://github.com/B30780/AOI_inference_agent/issues/8
depends_on: [5, 6, 7]
parallel: false
conflicts_with: []
---
...
## Dependencies
- [ ] Task 5 completed (upload endpoints)
- [ ] Task 6 completed (query endpoints)
- [ ] Task 7 completed (download endpoints)
